...
## Material
- Skriv ut bilderna från "Enskilda övningar", en eller ett par per grupp (laminera gärna, de kan återanvändas varje år)
...
4. **Redovisning (8-10 min):** Varje grupp visar upp sitt övningskort och presenterar det för resten av laget: namnet de gett den och vad de kom fram till att man tränar. Fyll på om de missat något syfte.
...
## Extrapoäng
- Kan de komma på "nästa nivå" av övningen? Vi gör ofta en enklare variant först som senare byggs på med ett till moment för att göra den svårare. Skriv gärna med det på kortet också.
...
## TODO
- [ ] Skriv ut bilderna från "Enskilda övningar" inför passet. Varje grupp ska ha en av varje övning. Tillräckligt stora för att kunna skriva på baksidan.
